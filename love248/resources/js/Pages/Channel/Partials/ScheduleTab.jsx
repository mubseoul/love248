    ...
    <div className="mt-4">
      ...
      {Object.keys(schedule).map((key, index) => {
        return (
          <div
            key={`schedule-${index}`}
            className="flex mb-5 md:items-center flex-col md:flex-row md:space-x-2 bg-footer shadow shadow p-3 text-white font-semibold"
          >
            <div className="md:w-24 md:text-sm mb-2 mb-sm-0 text-white bg-primary rounded-lg py-1.5 mr-2 text-center text-capitalize">
