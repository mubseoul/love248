            ...
            return (
              <div key={`schedule-${index}`}>
                <div className="flex mb-5 md:items-center flex-col md:flex-row md:space-x-2">
                  <div className="md:w-24 md:text-sm mb-2 md:mb-0 text-gray-primary bg-dark py-3 text-center">
                  ...
                  <div className="flex items-center space-x-2">
                    <NumberInput
                      ...
                      className="w-full md:w-20 form-control"
                      handleChange={(e) =>
                        updateSchedule(key, "from_hour", e.target.value)
                      }
                    />
                    <span className="py-2 px-3 text-white bg-dark rounded-sm">
                      :
                    </span>
                    <NumberInput
                      type="number"
                      ...
                      className="w-full md:w-20 form-control"
                      handleChange={(e) =>
                        updateSchedule(key, "from_minute", e.target.value)
                      }
                    />
                    <select
                      ...
                      onChange={(e) =>
                        updateSchedule(key, "from_type", e.target.value)
                      }
                      required
                      className={`w-20 border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm  form-select`}
                    >
                      <option value={"AM"}>{__("AM")}</option>
                      <option value={"PM"}>{__("PM")}</option>
                    </select>
                  </div>
                  <InputLabel className="my-3 md:my-0">{__("To")}</InputLabel>
                  ...
                  <div className="flex items-center space-x-2">
                    <NumberInput
                      ...
                      handleChange={(e) =>
                        updateSchedule(key, "to_hour", e.target.value)
                      }
                    />
                    <span className="py-2 px-3 text-white bg-dark rounded-sm">
                      :
                    ...
                    <NumberInput
                      ...
                      handleChange={(e) =>
                        updateSchedule(key, "to_minute", e.target.value)
                      }
                    />
                    <select
                      ...
                      onChange={(e) =>
                        updateSchedule(key, "to_type", e.target.value)
                      }
                      required
                      className={`w-20 border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm  form-select `}
                    >
