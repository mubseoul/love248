...
<head>
  ...
  <link rel="stylesheet" href="{{asset('web/assets/css/core/libs.min.css')}}" />
  
  <!-- font-awesome css -->
  <link rel="stylesheet" href="{{asset('web/assets/vendor/font-awesome/css/all.min.css')}}" />
  
  <!-- Iconly css -->
  <link rel="stylesheet" href="{{asset('web/assets/vendor/iconly/css/style.css')}}" />
  
  <!-- Animate css -->
  <link rel="stylesheet" href="{{asset('web/assets/vendor/animate.min.css')}}" />
  
  <!-- SwiperSlider css -->
  <link rel="stylesheet" href="{{asset('web/assets/vendor/swiperSlider/swiper.min.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('web/assets/css/streamit.min.css?v=1.0.0')}}" />
  
  <!-- Custom Css -->
  <link rel="stylesheet" href="{{asset('web/assets/css/custom.min.css?v=1.0.0')}}" />
  
  <!-- Rtl Css -->
  <link rel="stylesheet" href="{{asset('web/assets/css/rtl.min.css?v=1.0.0')}}" />
...
<body class=" custom-header-relative ">
  ...
  <div class="loader simple-loader">
     <div class="loader-body">
        <img src="{{asset('web/assets/images/loader.gif')}}" alt="loader" class="img-fluid " width="300">
      </div>
  </div>
                  ...
                  <div class="d-flex gap-3 gap-xl-0 align-items-center">
                     ...
                     <div class="logo-default">
                         <a class="navbar-brand text-primary" href="./index.html"> 
                             <img class="img-fluid logo" src="{{asset('web/assets/images/logo.webp')}}" loading="lazy" alt="streamit" />
                         </a>
                     </div>
                     <div class="logo-hotstar">
                         <a class="navbar-brand text-primary" href="./index.html"> 
                             <img class="img-fluid logo" src="{{asset('web/assets/images/logo-hotstar.webp')}}" loading="lazy" alt="streamit" />
                         </a>
                     </div> 
                     <div class="logo-prime">
                         <a class="navbar-brand text-primary" href="./index.html"> 
                             <img class="img-fluid logo" src="{{asset('web/assets/images/logo-prime.webp')}}" loading="lazy" alt="streamit" />
                         </a>
                     </div> 
                     <div class="logo-hulu">
                         <a class="navbar-brand text-primary" href="./index.html"> 
                             <img class="img-fluid logo" src="{{asset('web/assets/images/logo-hulu.webp')}}" loading="lazy" alt="streamit" />
                         </a>
                     </div>
                           ...
                           <li class="nav-item dropdown" id="itemdropdown1">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end dropdown-user border-0 p-0 m-0"
                                 ...
                                 <li class="user-info d-flex align-items-center gap-3 mb-3">
                                    <img src="{{asset('web/assets/images/user/user1.webp')}}" class="img-fluid" alt="" loading="lazy">
   ...
   <div class="slider m-0 p-0 swiper-wrapper home-slider">
      <div class="swiper-slide slide s-bg-1 p-0">
         <div class="banner-home-swiper-image">
            <img src="{{asset('web/assets/images/movies/banner1.webp')}}" alt="banner-home-swiper-image">
         </div>
            ...
            <div class="slider-inner h-100">
               <div class="row align-items-center iq-ltr-direction h-100">
                  <div class="col-lg-7 col-md-12">
                     ...
                     <div class="d-flex flex-wrap align-items-center r-mb-23 RightAnimate-two">
                        <div class="slider-ratting d-flex align-items-center">
                           ...
                           <span class="ms-2">
                           <img src="{{asset('web/assets/images/movies/imdb-logo.svg')}}" alt="imdb logo" class="img-fluid">
                           </span>
                        </div>
                  ...
                  <div class="col-lg-5 col-md-12 trailor-video iq-slider d-none d-lg-block">
                     <a href="{{asset('web/assets/images/video/trailer.mp4')}}" class="video-open playbtn text-decoration-none"
                        tabindex="0">
      ...
      <div class="swiper-slide slide s-bg-1 p-0">
         <div class="banner-home-swiper-image">
            <img src="{{asset('web/assets/images/movies/banner2.webp')}}" alt="banner-home-swiper-image">
         </div>
         <div class="container-fluid position-relative h-100">
            <div class="slider-inner h-100">
               <div class="row align-items-center iq-ltr-direction h-100">
      ...
      <div class="swiper-slide slide s-bg-1 p-0">
         <div class="banner-home-swiper-image">
            <img src="{{asset('web/assets/images/movies/banner3.webp')}}" alt="banner-home-swiper-image">
         </div>
         <div class="container-fluid position-relative h-100">
            <div class="slider-inner h-100">
               <div class="row align-items-center iq-ltr-direction h-100">
                      ...
                      <div class="block-images position-relative">
                          <div class="iq-image-box overly-images">
                              <a href="./movie-detail.html" class="d-block">
                                  <img src="{{asset('web/assets/images/continue-watch/01.webp')}}" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                              </a>
                          </div>
               ...
               <li class="swiper-slide">
                  <div class="iq-watching-block">
                      <div class="block-images position-relative">
                          <div class="iq-image-box overly-images">
                              <a href="./movie-detail.html" class="d-block">
                                  <img src="{{asset('web/assets/images/continue-watch/02.webp')}}" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                              </a>
                          </div>
                          <div class="iq-preogress">
               ...
               <li class="swiper-slide">
                  <div class="iq-watching-block">
                      <div class="block-images position-relative">
                          <div class="iq-image-box overly-images">
                              <a href="./movie-detail.html" class="d-block">
                                  <img src="{{asset('web/assets/images/continue-watch/03.webp')}}" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                              </a>
                          </div>
                          <div class="iq-preogress">
               ...
               <li class="swiper-slide">
                  <div class="iq-watching-block">
                      <div class="block-images position-relative">
                          <div class="iq-image-box overly-images">
                              <a href="./movie-detail.html" class="d-block">
                                  <img src="{{asset('web/assets/images/continue-watch/04.webp')}}" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                              </a>
                          </div>
                          <div class="iq-preogress">
                              <span class="data-left-timing font-size-14 fw-500 text-lowercase">60 of 134 m</span>
               ...
               <li class="swiper-slide">
                  <div class="iq-watching-block">
                      <div class="block-images position-relative">
                          <div class="iq-image-box overly-images">
                              <a href="./movie-detail.html" class="d-block">
                                  <img src="{{asset('web/assets/images/continue-watch/05.webp')}}" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                              </a>
                          </div>
                          <div class="iq-preogress">
                       ...
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             ...
                             <img src="{{asset('web/assets/images/movies/upcoming/01.webp')}}" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/upcoming/02.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/upcoming/03.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/upcoming/04.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/upcoming/05.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/upcoming/06.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/upcoming/07.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
               ...
               <ul class="p-0 swiper-wrapper m-0  list-inline">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="{{route('movie-detail',$video->id)}}" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{$video->thumbnail}}" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                                 <h5 class="iq-title text-capitalize">
                                   <a href="{{route('movie-detail',$video->id)}}">mortal nories</a>
                                 </h5>
                                 <div class="movie-time d-flex align-items-center my-2">
                                   <span class="movie-time-text font-normal">2hr : 12mins</span>
                                 </div>
                               ...
                               <div class="watchlist">
                                 <a class="watch-list-not" href="{{route('movie-detail',$video->id)}}">
                                   <svg width="10" height="10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-10">
                                     <path d="M12 4V20M20 12H4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                   </svg>
                                   <span class="watchlist-label"> Watchlist </span>
                           ...
                           <div class="block-social-info align-items-center">
                             ...
                             <div class="iq-button">
                               <a href="{{route('movie-detail',$video->id)}}" class="btn text-uppercase position-relative rounded-circle">
                                 <i class="fa-solid fa-play ms-0"></i>
                               </a>
                           </div>
                           </div>
                  ...
                  <div class="swiper-container " data-swiper="slider-thumbs-inner">
                     <div class="swiper-wrapper top-ten-slider-nav">
                        <div class="swiper-slide swiper-bg">
                           <div class="block-images position-relative ">
                              <div class="img-box slider--image">
                                 <img src="{{asset('web/assets')}}/images/top-10/06.webp" class="img-fluid" alt=""
                                    loading="lazy">
                              </div>
                        ...
                        <div class="swiper-slide swiper-bg">
                           <div class="block-images position-relative ">
                              <div class="img-box slider--image">
                                 <img src="{{asset('web/assets')}}/images/top-10/07.webp" class="img-fluid" alt=""
                                    loading="lazy">
                              </div>
                              <div class="block-description">
                        ...
                        <div class="swiper-slide swiper-bg">
                           <div class="block-images position-relative">
                              <div class="img-box slider--image">
                                 <img src="{{asset('web/assets')}}/images/top-10/08.webp" class="img-fluid" alt=""
                                    loading="lazy">
                              </div>
                              <div class="block-description">
                        ...
                        <div class="swiper-slide swiper-bg">
                           <div class="block-images position-relative">
                              <div class="img-box slider--image">
                                 <img src="{{asset('web/assets')}}/images/top-10/09.webp" class="img-fluid" alt=""
                                    loading="lazy">
                              </div>
                              <div class="block-description">
                        ...
                        <div class="swiper-slide swiper-bg">
                           <div class="block-images position-relative">
                              <div class="img-box slider--image">
                                 <img src="{{asset('web/assets')}}/images/top-10/05.webp" class="img-fluid" alt=""
                                    loading="lazy">
                              </div>
                              <div class="block-description">
               ...
               <div class="swiper-container " data-swiper="slider-images-inner">
                  <div class="swiper-wrapper ">
                     <div class="swiper-slide">
                        <div class="slider--image block-images"><img src="{{asset('web/assets')}}/images/top-10/06.webp"
                     ...
                     <div class="swiper-slide">
                        <div class="slider--image block-images"><img src="{{asset('web/assets')}}/images/top-10/07.webp"
                           loading="lazy" alt="" /></div>
                        <div class="description">
                           <div class="block-description">
                              <ul class="ps-0 mb-0 mb-1 pb-1 list-inline d-flex flex-wrap align-items-center movie-tag">
                     ...
                     <div class="swiper-slide">
                        <div class="slider--image block-images"><img src="{{asset('web/assets')}}/images/top-10/08.webp"
                           loading="lazy" alt="" /></div>
                        <div class="description">
                           <div class="block-description">
                              <ul class="ps-0 mb-0 mb-1 pb-1 list-inline d-flex flex-wrap align-items-center movie-tag">
                     ...
                     <div class="swiper-slide">
                        <div class="slider--image block-images"><img src="{{asset('web/assets')}}/images/top-10/09.webp"
                           loading="lazy" alt="" /></div>
                        <div class="description">
                           <div class="block-description">
                              <ul class="ps-0 mb-0 mb-1 pb-1 list-inline d-flex flex-wrap align-items-center movie-tag">
                     ...
                     <div class="swiper-slide">
                        <div class="slider--image block-images"><img src="{{asset('web/assets')}}/images/top-10/05.webp"
                           loading="lazy" alt="" /></div>
                        <div class="description">
                           <div class="block-description">
                              <ul class="ps-0 mb-0 mb-1 pb-1 list-inline d-flex flex-wrap align-items-center movie-tag">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/suggested/01.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/suggested/02.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/suggested/03.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/suggested/04.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/suggested/05.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/suggested/06.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/suggested/07.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
...
<section id="parallex" class="parallax-window bg-attachment-fixed" style="background:url({{asset('web/assets')}}/images/parallax/parallex.webp) fixed;">
      ...
      <div class="row align-items-center justify-content-center h-100 parallaxt-details">
         ...
         <div class="col-xl-7 col-lg-12 col-md-12 mt-5 mt-xl-0">
            <div class="parallax-img">
               ...
               <img src="{{asset('web/assets')}}/images/parallax/parallex.webp" class="img-fluid w-100" loading="lazy" alt="bailey">
               </a>
            </div>
         </div>
      </div>
                     ...
                     <li class="swiper-slide">
                        <a href="javascript:void(0);">
                           <div class="movie-swiper position-relative">
                              <img src="{{asset('web/assets')}}/images/movies/ott1.webp" alt="" />
                           </div>
                        </a>
                     </li>
                     <li class="swiper-slide">
                        <a href="javascript:void(0);">
                           <div class="movie-swiper position-relative">
                              <img src="{{asset('web/assets')}}/images/movies/ott2.webp" alt="" />
                           </div>
                        </a>
                     </li>
                     <li class="swiper-slide">
                        <a href="javascript:void(0);">
                           <div class="movie-swiper position-relative">
                              <img src="{{asset('web/assets')}}/images/movies/ott3.webp" alt="" />
                           </div>
                        </a>
                     </li>
                     <li class="swiper-slide">
                        <a href="javascript:void(0);">
                           <div class="movie-swiper position-relative">
                              <img src="{{asset('web/assets')}}/images/movies/banner1.webp" alt="" />
                           </div>
                        </a>
                     </li>
                     <li class="swiper-slide">
                        <a href="javascript:void(0);" tabindex="0">
                           <div class="movie-swiper position-relative">
                              <img src="{{asset('web/assets')}}/images/movies/banner2.webp" alt="" />
                           </div>
                        </a>
                     </li>
                     <li class="swiper-slide">
                        <a href="javascript:void(0);" tabindex="0">
                           <div class="movie-swiper position-relative">
                              <img src="{{asset('web/assets')}}/images/movies/banner3.webp" alt="" />
                           </div>
                        </a>
                     </li>
                  </ul>
                  ...
                  <ul class="swiper-wrapper list-inline p-0 m-0 d-flex align-items-center trending-slider">
                     <li class="swiper-slide slider-big-img-1 p-0">
                        <div class="trending-tab-slider-image">
                           <img src="{{asset('web/assets')}}/images/movies/ott1.webp" alt="trending-tab-slider-image">
                        </div>
                                    ...
                                    <div
                                       ...
                                       <div class="d-flex align-items-center flex-wrap series mb-4 gap-3">
                                          <a href="javascript:void(0);"><img
                                                src="{{asset('web/assets')}}/images/movies/trending-label.webp" class="img-fluid"
                                                alt=""></a>
                                          ...
                                          <ul class="p-0 swiper-wrapper m-0  list-inline">
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/episodes/01.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/episodes/02.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/episodes/03.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/episodes/04.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/episodes/05.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                       ...
                                       <div class="episodes-contens mt-5">
                                          <div
                                             ...
                                             <div class="tab-watch-trailer position-relative rounded-3 overflow-hidden">
                                                <img src="{{asset('web/assets')}}/images/tv-show/season/01.webp"
                                                   class="trailer-image" alt="trailer-image">
                                                <a href="{{asset('web/assets')}}/images/video/trailer.mp4"
                                          ...
                                          <ul class="p-0 swiper-wrapper m-0  list-inline">
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/02.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/03.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/04.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/05.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/06.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                     ...
                     <li class="swiper-slide slider-big-img-2">
                        <div class="trending-tab-slider-image">
                           <img src="{{asset('web/assets')}}/images/movies/ott2.webp" alt="trending-tab-slider-image">
                        </div>
                        <div class="tranding-block position-relative">
                           <div class="trending-custom-tab">
                              <div class="tab-title-info position-relative">
                                          ...
                                          <ul class="p-0 swiper-wrapper m-0  list-inline">
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/01.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E01</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                    ...
                                    <div
                                       ...
                                       <div class="episodes-contens mt-5">
                                          <div
                                             class="tab-watch-trailer-container d-inline-block rounded-3 overflow-hidden">
                                             <div class="tab-watch-trailer position-relative rounded-3 overflow-hidden">
                                                <img src="{{asset('web/assets')}}/images/tv-show/episodes/01.webp"
                                                   class="trailer-image" alt="trailer-image">
                                                <a href="{{asset('web/assets')}}/images/video/trailer.mp4"
                                                   class="video-open playbtn text-decoration-none" tabindex="0">
                                                   <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                          ...
                                          <ul class="p-0 swiper-wrapper m-0  list-inline">
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/movies/ott2.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-2</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/movies/ott3.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-3</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/movies/banner1.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-4</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/movies/banner2.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-5</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/movies/banner3.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-6</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                     ...
                     <li class="swiper-slide slider-big-img-3">
                        <div class="trending-tab-slider-image">
                           <img src="{{asset('web/assets')}}/images/movies/ott3.webp" alt="trending-tab-slider-image">
                        </div>
                        <div class="tranding-block position-relative">
                           <div class="trending-custom-tab">
                              <div class="tab-title-info position-relative">
                                          ...
                                          <ul class="p-0 swiper-wrapper m-0  list-inline">
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/25.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E01</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/26.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E02</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/27.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E03</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/28.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E04</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/29.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E05</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                    ...
                                    <div
                                       ...
                                       <div class="episodes-contens mt-5">
                                          <div
                                             class="tab-watch-trailer-container d-inline-block rounded-3 overflow-hidden">
                                             <div class="tab-watch-trailer position-relative rounded-3 overflow-hidden">
                                                <img src="{{asset('web/assets')}}/images/tv-show/season/35.webp"
                                                   class="trailer-image" alt="trailer-image">
                                                <a href="{{asset('web/assets')}}/images/video/trailer.mp4"
                                                   class="video-open playbtn text-decoration-none" tabindex="0">
                                                   <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                          ...
                                          <ul class="p-0 swiper-wrapper m-0  list-inline">
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/30.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-2</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/31.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-3</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/32.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-4</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/33.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-5</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/34.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">Seasons 1-6</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                     ...
                     <li class="swiper-slide slider-big-img-4">
                        <div class="trending-tab-slider-image">
                           <img src="{{asset('web/assets')}}/images/movies/banner1.webp" alt="trending-tab-slider-image">
                        </div>
                        <div class="tranding-block position-relative">
                           <div class="trending-custom-tab">
                              <div class="tab-title-info position-relative">
                                          ...
                                          <ul class="p-0 swiper-wrapper m-0  list-inline">
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/11.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E01</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/12.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E02</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/13.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E03</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/14.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E04</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/15.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E05</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                     ...
                     <li class="swiper-slide slider-big-img-5">
                        <div class="trending-tab-slider-image">
                           <img src="{{asset('web/assets')}}/images/movies/banner2.webp" alt="trending-tab-slider-image">
                        </div>
                        <div class="tranding-block position-relative">
                           <div class="trending-custom-tab">
                              <div class="tab-title-info position-relative">
                                          ...
                                          <ul class="p-0 swiper-wrapper m-0  list-inline">
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/16.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E01</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/17.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E02</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/18.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E03</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/19.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E04</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/20.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E05</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                     ...
                     <li class="swiper-slide slider-big-img-6">
                        <div class="trending-tab-slider-image">
                           <img src="{{asset('web/assets')}}/images/movies/banner3.webp" alt="trending-tab-slider-image">
                        </div>
                        <div class="tranding-block position-relative">
                           <div class="trending-custom-tab">
                              <div class="tab-title-info position-relative">
                                          ...
                                          <ul class="p-0 swiper-wrapper m-0  list-inline">
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/21.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E01</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/22.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E02</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/23.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E03</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
                                             ...
                                             <li class="swiper-slide">
                                                <div class="episode-block">
                                                    <div class="block-image position-relative">
                                                        <a href="./episode.html">
                                                            <img src="{{asset('web/assets')}}/images/tv-show/season/24.webp" class="img-fluid img-zoom" alt="showImg-" loading="lazy">
                                                        </a>
                                                        <div class="episode-number">S01E04</div>
                                                        <div class="episode-play">
                                                            <a href="./episode.html" tabindex="0"><i class="fa-solid fa-play"></i></a>
...
<div class="recommended-block">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/recommended/01.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/recommended/02.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/recommended/03.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/recommended/04.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/recommended/05.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/recommended/06.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                  ...
                  <li class="swiper-slide">
                       <div class="iq-card card-hover">
                         <div class="block-images position-relative w-100">
                           <div class="img-box w-100">
                             <a href="./movie-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                             <img src="{{asset('web/assets')}}/images/movies/recommended/07.webp" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                           </div>
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
          ...
          <div class="col-md-3">
            ...
            <div class="d-flex align-items-center">
              <a class="app-image" href="#">
                <img src="{{asset('web/assets')}}/images/footer/google-play.webp" loading="lazy" alt="play-store" />
              </a>
              <br />
              <a class="ms-3 app-image" href="#">
                <img src="{{asset('web/assets')}}/images/footer/apple.webp" loading="lazy" alt="app-store" />
              </a>
            </div>
          </div>
        </div>
  ...
  <script src="{{asset('web/assets/js/core/libs.min.js')}}"></script>
  <!-- Plugin Scripts -->
  
  
  <!-- SwiperSlider Script -->
  <script src="{{asset('web/assets/vendor/swiperSlider/swiper.min.js')}}"></script>
  
  
    <!-- Select2 Script -->
    <script src="{{asset('web/assets/js/plugins/select2.js')}}" defer></script>
  
  
  <!-- Lodash Utility -->
  <script src="{{asset('web/assets/vendor/lodash/lodash.min.js')}}"></script>
  <!-- External Library Bundle Script -->
  <script src="{{asset('web/assets/js/core/external.min.js')}}"></script>
  <!-- countdown Script -->
  <script src="{{asset('web/assets/js/plugins/countdown.js')}}"></script>
  <!-- utility Script -->
  <script src="{{asset('web/assets/js/utility.js')}}"></script>
  <!-- Setting Script -->
  <script src="{{asset('web/assets/js/setting.js')}}"></script>
  <script src="{{asset('web/assets/js/setting-init.js')}}" defer></script>
  <!-- Streamit Script -->
  <script src="{{asset('web/assets/js/streamit.js')}}" defer></script>
  <script src="{{asset('web/assets/js/swiper.js')}}" defer></script>
</body>
