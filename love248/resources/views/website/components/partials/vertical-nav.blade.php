...
<ul class="navbar-nav iq-main-menu" id="sidebar-menu">
    <li class="nav-item">
        <a class="nav-link {{ activeRoute(route('dashboard.home')) }} {{ activeRoute(route('dashboard')) }}"
            aria-current="page" href="{{ route('dashboard.home') }}">
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar-menu">
            ...
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('dashboard.fixed')) }}"
                    href="{{ route('dashboard.fixed') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('dashboard.fancy')) }}"
                    href="{{ route('dashboard.fancy') }}">
