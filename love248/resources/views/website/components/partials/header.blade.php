<nav class="nav navbar navbar-expand-xl header-hover-menu navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
        <a href="{{ route('frontend.ott') }}" class="navbar-brand">
        </a>
            ...
            <div class="offcanvas offcanvas-end shadow-none iq-product-menu-responsive" tabindex="-1"
                ...
                <div class="offcanvas-body">
                    <ul class="iq-nav-menu list-unstyled">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('dashboard.movie-list') }}">Movie
                                List</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                id="tv-shows">
                                <li class="nav-item"><a class="nav-link" href="{{ route('dashboard.show-list') }}">Show
                                        List</a></li>
                                <li class="nav-item"><a class="nav-link"
                                        href="{{ route('dashboard.seasons') }}">Season</a></li>
                                <li class="nav-item"><a class="nav-link"
                                        href="{{ route('dashboard.episodes') }}">Episodes</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 ">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile-setting">
                        ...
                        <li><a class="dropdown-item" href="{{ route('dashboard.privacy') }}">Privacy
                                Setting</a></li>
                        <li>
