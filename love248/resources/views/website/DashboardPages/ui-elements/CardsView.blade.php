...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height bg-dark text-white mb-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="iq-card text-white bg-primary mb-4">
                    <div class="iq-card-body">
            ...
            <div class="col-lg-4">
                <div class="iq-card mb-4 text-white bg-secondary">
                    <div class="iq-card-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="card-columns">
                    ...
                    <div class="iq-card text-center mb-4">
                        <div class="iq-card-body">
                            <h4 class="card-title">Card title</h4>
