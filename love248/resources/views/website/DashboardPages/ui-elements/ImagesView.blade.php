                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('dashboard/images/page-img/15.jpg') }}" class="img-fluid avatar-70 me-3"
                                alt="#" loading="lazy">
                        ...
                        <div class="d-flex align-items-start mt-2">
                            <img src="{{ asset('dashboard/images/page-img/16.jpg') }}" class="img-fluid avatar-70 me-3"
                                alt="#" loading="lazy">
                            <div class="flex-grow-1">
                                <h5 class="mt-0">Media heading</h5>
                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin.
                                ...
                                <div class="d-flex align-items-start mt-3">
                                    <a class="me-3" href="#">
                                        <img src="{{ asset('dashboard/images/page-img/17.jpg') }}"
                                            class="avatar-70 img-fluid" alt="#" loading="lazy">
                                    </a>
                                    <div class="flex-grow-1">
                                        <h5 class="mt-0">Media heading</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <img src="{{ asset('dashboard/images/page-img/18.jpg') }}" class="ms-3 img-fluid avatar-70"
                                alt="#" loading="lazy">
                        </div>
                        <div class="d-flex align-items-center mb-5">
                            <div class="">
                            ...
                            <img src="{{ asset('dashboard/images/page-img/19.jpg') }}"
                                class="align-self-center ms-3 img-fluid avatar-70" alt="#" loading="lazy">
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <img src="{{ asset('dashboard/images/page-img/20.jpg') }}"
                                class="align-self-end ms-3 img-fluid avatar-70" alt="#" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <img src="{{ asset('dashboard/images/page-img/10.jpg') }}" class="img-thumbnail"
                            alt="Responsive image" loading="lazy">
                        <img src="{{ asset('dashboard/images/page-img/11.jpg') }}" class="rounded ms-3"
                            alt="Responsive image" loading="lazy">
                        <img src="{{ asset('dashboard/images/page-img/12.jpg') }}" class="rounded-circle ms-3 mt-3"
                            alt="Responsive image" loading="lazy">
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>In addition to our <a href="/docs/4.3/utilities/borders/">border-radius utilities</a>, you can
                            use <code>.img-thumbnail</code> to give an image a rounded 1px border appearance.</p>
                        <img src="{{ asset('dashboard/images/page-img/13.jpg') }}" class=" mt-2 img-fluid rounded"
                            alt="Responsive image"> loading="lazy">
                        <img src="{{ asset('dashboard/images/page-img/14.jpg') }}"
                            class=" mt-2 img-fluid rounded float-right" alt="Responsive image" loading="lazy">
                    </div>
                </div>
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <img src="{{ asset('dashboard/images/page-img/21.jpg') }}"
                                class="align-self-start me-3 img-fluid avatar-70" alt="#" loading="lazy">
                            <div class="">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <img src="{{ asset('dashboard/images/page-img/22.jpg') }}"
                                class="align-self-center me-3 img-fluid avatar-70" alt="#" loading="lazy">
                            <div class="">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('dashboard/images/page-img/23.jpg') }}"
                                class="align-self-end me-3 img-fluid avatar-70" alt="#" loading="lazy">
                            <div class="">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled">
                            <li class="d-flex align-items-center">
                                <img src="{{ asset('dashboard/images/page-img/24.jpg') }}"
                                    class="me-3 img-fluid avatar-70" alt="#" loading="lazy">
                                <div class="">
                            ...
                            <li class="d-flex align-items-center my-4">
                                <img src="{{ asset('dashboard/images/page-img/15.jpg') }}"
                                    class="me-3 img-fluid avatar-70" alt="#" loading="lazy">
                                <div class="">
                                    <h5 class="mt-0 mb-1">List-based media object</h5>
                                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                            ...
                            <li class="d-flex align-items-center">
                                <img src="{{ asset('dashboard/images/page-img/16.jpg') }}"
                                    class="me-3 img-fluid avatar-70" alt="#" loading="lazy">
                                <div class="">
                                    <h5 class="mt-0 mb-1">List-based media object</h5>
                                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
