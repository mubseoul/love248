        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="mb-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="mt-2 btn btn-secondary">
                            <svg width="16" height="15" class="me-2" viewBox="0 0 22 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M15 4.69995C16.07 5.04595 16.826 6.00095 16.917 7.12195" stroke="currentColor"
                        ...
                        <button type="button" class="mt-2 btn btn-light"><svg width="15" height="16"
                                class="me-2" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.7162 14.2236H5.49622" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M12.7162 10.0371H5.49622" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <button type="button" class="mt-2 btn btn-link">
                            <svg width="15" height="16" class="me-2" viewBox="0 0 19 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.7162 14.2236H5.49622" stroke="#2e46ba" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M12.7162 10.0371H5.49622" stroke="#2e46ba" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M8.25131 5.86035H5.49631" stroke="#2e46ba" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M12.9086 0.75C12.9086 0.75 5.23161 0.754 5.21961 0.754C2.45961 0.771 0.75061 2.587 0.75061 5.357V14.553C0.75061 17.337 2.47261 19.16 5.25661 19.16C5.25661 19.16 12.9326 19.157 12.9456 19.157C15.7056 19.14 17.4156 17.323 17.4156 14.553V5.357C17.4156 2.573 15.6926 0.75 12.9086 0.75Z"
                                    stroke="#2e46ba" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>Link</button>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-secondary mt-2">
                            <svg width="16" height="15" class="me-2" viewBox="0 0 22 19" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M11.0024 10.4147V7.3147" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M10.995 13.5H11.005" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>Secondary</button>
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="mb-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                            Ipsum has been the industry's standard dummy text ever</p>
                        <button type="button" class="btn btn-primary mt-2"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button type="button" class="btn btn-secondary mt-2"><svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-star" width="20" height="20"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path
                        ...
                        <button type="button" class="btn btn-success mt-2"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button type="button" class="btn btn-danger mt-2"><svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-video" width="20" height="20"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path
                        ...
                        <button type="button" class="btn btn-warning mt-2"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button type="button" class="btn btn-info mt-2"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button type="button" class="btn btn-light mt-2"><svg xmlns="http://www.w3.org/2000/svg"
                                width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <button type="button" class="btn btn-dark mt-2"><svg xmlns="http://www.w3.org/2000/svg"
                                width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <div class="d-inline-block w-100">
                            <button type="button" class="btn btn-primary mt-2">
                                <svg width="16" height="15" class="me-2" viewBox="0 0 22 20"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M1.87187 9.59832C0.798865 6.24832 2.05287 2.41932 5.56987 1.28632C7.41987 0.689322 9.46187 1.04132 10.9999 2.19832C12.4549 1.07332 14.5719 0.693322 16.4199 1.28632C19.9369 2.41932 21.1989 6.24832 20.1269 9.59832C18.4569 14.9083 10.9999 18.9983 10.9999 18.9983C10.9999 18.9983 3.59787 14.9703 1.87187 9.59832Z"
                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M15 4.69995C16.07 5.04595 16.826 6.00095 16.917 7.12195"
                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>Buttons</button>
                            <button type="button" class="btn btn-secondary mt-2"><svg class="me-2"
                            ...
                            <button type="button" class="btn btn-success mt-2"><svg class="me-2"
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="15"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <button type="button" class="btn btn-danger mt-2"><svg class="me-2"
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="15"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <button type="button" class="btn btn-info mt-2"><svg class="me-2"
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body ui-button-group">
                        <p class="mb-1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                            Ipsum has been the industry's standard dummy text ever</p>
                        ...
                        <div class="btn-toolbar " role="toolbar" aria-label="Toolbar with button groups">
                            ...
                            <div class="btn-group btn-group-medium me-2 mt-2" role="group"
