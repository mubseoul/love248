@extends('layouts.app',['isCircleProgress'=>true])
                    ...
                    <div class="d-flex  justify-content-start align-items-center mb-3">
                        <div class="pe-3">
                            <img src="{{ asset('dashboard/images/avatars/02.png') }}" loading="lazy"
                                class="rounded-circle p-1 bg-soft-danger" width="60" height="60" alt="1">
                        </div>
                        <div>
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="media-support-user-img me-3">
                                <img class="rounded-circle p-1 bg-soft-danger img-fluid avatar-60"
                                    src="{{ asset('dashboard/images/avatars/02.png') }}" loading="lazy" alt="">
                            </div>
                    ...
                    <div class="comment-area mt-3">
                        ...
                        <ul class="post-comments p-0 list-inline">
                            <li class="mb-3">
                                <div class="d-flex flex-wrap">
                                    <div class="user-img">
                                        <img src="{{ asset('dashboard/images/avatars/03.png') }}" alt="userimg" loading="lazy"
                                            class="p-1 bg-soft-primary avatar-60 rounded-circle img-fluid">
                                    </div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-card grid-cols-3">
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/icon/04.png') }}">
                            <img src="{{ asset('dashboard/images/icon/04.png') }}"
                                class="img-fluid bg-soft-info rounded" alt="profile-image" loading="lazy">
                        </a>
                        ...
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/icon/08.png') }}">
                            <img src="{{ asset('dashboard/images/icon/08.png') }}"
                                class="img-fluid bg-soft-info rounded" alt="profile-image" loading="lazy">
                        </a>
                        ...
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/icon/01.png') }}">
                            <img src="{{ asset('dashboard/images/icon/01.png') }}"
                                class="img-fluid bg-soft-success rounded" alt="profile-image" loading="lazy">
                        </a>
                    </div>
                </div>
            </div>
