...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-sm-6 col-lg-6 col-xl-3">
                        <div class="card iq-card iq-card-block iq-card-stretch iq-card-height">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="icon iq-icon-box-top rounded-circle bg-primary">
                                        <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="16"
                                            viewBox="0 0 24 24">
                ...
                <div class="card iq-card">
                    <div
                        class="card-header iq-card-header d-flex justify-content-between align-items-center top-rated-slider">
            ...
            <div class="col-lg-4">
                <div class="card iq-card iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="card-header iq-card-header">
                        <div class="card-title iq-header-title">
                            <h4 class="card-title text-center">User's Of Product</h4>
                        </div>
                    </div>
                    <div class="card-body iq-card-body pb-0">
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-4">
                <div class="card iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="card-body">
                        <div class="card-header iq-card-header d-flex align-items-center justify-content-between">
                            <div class="card-title iq-header-title">
                ...
                <div class="card iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="card-body">
                        <div class="card-header iq-card-header d-flex align-items-center justify-content-between">
                            ...
                            <div class="card-header iq-card-header-toolbar d-flex align-items-center seasons">
                        ...
                        <div class="card-body iq-card-body row align-items-center">
                            <div class="col-lg-7">
                                <div class="row list-unstyled mb-0 pb-0">
                                    <div class="col-sm-6 col-md-4 col-lg-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="iq-icon-box-view rounded me-3 iq-bg-primary"><i
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="iq-icon-box-view rounded me-3 iq-bg-secondary"><i
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="iq-icon-box-view rounded me-3 iq-bg-info"><i
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="iq-icon-box-view rounded me-3 iq-bg-warning"><i
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-6 mb-lg-0 mb-3">
                                        <div class="iq-progress-bar progress-bar-vertical iq-bg-success">
                                            <span class="bg-success" data-percent="100"
                                                style="transition: height 2s ease 0s; width: 100%; height: 60%;"></span>
                                        </div>
                                        <div class="d-flex align-items-center mb-lg-0 mb-3">
                                            <div class="iq-icon-box-view rounded me-3 iq-bg-success"><i
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-6  mb-lg-0 mb-3">
                                        <div class="iq-progress-bar progress-bar-vertical iq-bg-danger">
                                            <span class="bg-danger" data-percent="100"
                                                style="transition: height 2s ease 0s; width: 100%; height: 80%;"></span>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="iq-icon-box-view rounded me-3 iq-bg-danger"><i
            ...
            <div class="col-sm-12">
                <div class="card iq-card">
                    <div class="card-body">
                        <div class="card-header iq-card-header d-flex justify-content-between">
                            <div class="card-title iq-header-title">
