...
<head> 
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/core/libs.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendor/sheperd/dist/css/sheperd.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendor/flatpickr/dist/flatpickr.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/streamit.min.css?v=1.0.1') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/custom.min.css?v=1.0.1') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/dashboard-custom.min.css?v=1.0.1') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/dark.min.css?v=1.0.1') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/customizer.min.css?v=1.0.1') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/rtl.min.css?v=1.0.1') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendor/swiperSlider/swiper-bundle.min.css') }}" />
    <!-- Google Font -->
...
<body>
    ...
    <!-- loader Start -->
    <div id="loading" style="background:#000 !important">
         <div class="loader simple-loader" style="background:#000 !important">
            <div class="loader-body" style="background:#000 !important">
               <img src="{{ asset('assets/images/Marca-Love-248.gif.tmp')}}" alt="loader" class="image-loader img-fluid ">
            </div>
         </div>
    </div>
    <!-- loader END -->
    ...
    <div class="position-relative ">
            ...
            <nav class="nav navbar navbar-expand-xl header-hover-menu navbar-light iq-navbar">
               <div class="container-fluid navbar-inner">
                  <a href="/admin" class="navbar-brand">
                     <!--Logo start-->
                     <img class="logo-normal" src="{{ asset(opt('site_logo')) }}" alt="#">
                  ...
                  <div class="d-flex align-items-center justify-content-between product-offcanvas">
                     <div class="breadcrumb-title pe-3 d-none d-xl-block">
                        <small class="mb-0 text-capitalize">@yield('section_title', '')</small>
                     </div>
                  </div>
                     ...
                     <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 ">
                        <li class="nav-item dropdown">
                           ...
                           <ul class="dropdown-menu dropdown-menu-end">
                              <li>
                                    <a href="{{ url()->current() }}?lang=en" class="dropdown-item d-flex align-items-center">
                                       <label class="d-block" for="theme-scheme-direction-ltr">
                                          <span class="ms-2 mb-0"> English </span>
                                       </label>

                                    </a>
                              </li>
                              <li>
                                    <a href="{{ url()->current() }}?lang=pt" class="dropdown-item d-flex align-items-center">
                                       <label class=" d-block" for="theme-scheme-direction-rtl">
                                          <span class="ms-2 mb-0"> Portuguese </span>
                                       </label>
                                    </a>
                              </li>
                           </ul>
                           ...
                           <ul class="list-unstyled dropdown-menu dropdown-content">
                              <li data-setting="radio">
                                 <div class="dropdown-item d-flex align-items-center">
                                    ...
                                    <label class="d-flex" for="color-mode-light">
                              ...
                              <li data-setting="radio">
                                 <div class="dropdown-item d-flex align-items-center">
                                    ...
                                    <label class="d-flex" for="color-mode-dark">
                                       <svg class="icon-24" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                          xmlns="http://www.w3.org/2000/svg">
                                          <path
                              ...
                              <li data-setting="radio">
                                 <div class="dropdown-item d-flex align-items-center">
                                    <input type="radio" value="auto" class="btn-check" name="theme_scheme" id="color-mode-auto"
                                       checked>
                                    <label class="d-flex" for="color-mode-auto">
                                       <svg class="icon-24" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                          xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item dropdown">
                           <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting" role="button"
                              ...
                              <img src="{{asset('assets/images/user/01.jpg')}}" alt="User-Profile"
                              ...
                              <div class="caption ms-3 d-none d-md-block ">
                                 ...
                                 <!-- <p class="mb-0 caption-sub-title">Twitcher Admin</p> -->
                              </div>
                           </a>
                           <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile-setting">
                              <!-- <li><a class="dropdown-item" href="../dashboard/app/user-profile.html">Profile</a></li> -->
                              <li><a class="dropdown-item" href="/admin/config-logins">Privacy Setting</a></li>
                              <!-- <li>
                                 <hr class="dropdown-divider">
                              </li> -->
                              <li><a class="dropdown-item text-capitalize" href="{{ route('logout') }}">{{__('message.logout')}}</a></li>
                           </ul>
                        </li>
                     </ul>
                  </div>
        ...
        <div class="content-inner container-fluid p-4 pb-0" id="page_layout">
            @yield('extra_top', '')
            @yield('section_body', '')
            @yield('extra_bottom', '')
        </div>
    ...
    <script type="text/javascript" src="{{asset('assets/vendor/sheperd/dist/js/sheperd.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/plugins/tour.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/vendor/flatpickr/dist/flatpickr.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/plugins/flatpickr.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('assets/vendor/swiperSlider/swiper-bundle.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/plugins/swiper-slider.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('assets/js/charts/widgetcharts.js?v=1.0.1')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/charts/dashboard.js?v=1.0.1')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/streamit.js?v=1.0.1')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/sidebar.js?v=1.0.1')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/chart-custom.js?v=1.0.1')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/plugins/flatpickr.js?v=1.0.1')}}"></script>
