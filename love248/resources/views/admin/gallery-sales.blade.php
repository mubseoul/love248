...
<strong class="text-capitalize">{{ __($active==='Gallery'?__('message.gallery_sales'):__('message.users_management'), ['type' => ucfirst($active)]) }}</strong>
@endsection
                    ...
                    <table id="commentTable" class="data-tables table custom-table movie_table" data-toggle="data-table">
                        <thead>
                            <tr>
                                ...
                                <x-th>{{ __('message.gallery_sales') }}</x-th>
                            </tr>
                        </thead>
                        <tbody>
