...
<strong>{{ __($active==='Stream'?__('message.stream_earning'):__('message.users_management'), ['type' => ucfirst($active)]) }}</strong>
@endsection
                    ...
                    <table id="commentTable" class="text-stone-600 table border-collapse w-full" data-toggle="data-table">
                        <thead>
                            <tr>
                                ...
                                <x-th>{{ __('message.stream_earning') }}</x-th>
                                <x-th>{{ __('message.tips_earning') }}</x-th>
                                <x-th>{{ __('message.total_earning') }}</x-th>
                            </tr>
                        </thead>
                        <tbody>
