...
<body>
    ...
    <!-- <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiase  text-white" style="background: #141314">
        ...
        <!-- <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            <main>
                <div class="shadow-sm sm:rounded-lg text-white  w-full mx-auto p-4" style="background: #080707E6;">
                    @yield('section_title', '')
                </div>
    ...
    <script type="text/javascript" src="{{asset('assets/js/plugins/select2.js?v=1.0.1')}}"></script>
